...
import ANTLR.PrincessParser.ExpressionContext;
...
public class Function {
    ...
    public PrincessValue invoke(List<ExpressionContext> params, Map<String, Function> functions, Scope scope) {
        ...
        for (int i = 0; i < this.params.size(); i++) {
            PrincessValue value = evalVisitor.visit(params.get(i));
            scope.assignParam(this.params.get(i).getText(), value);
        }
        PrincessValue ret = PrincessValue.VOID;
        try {
